                ...
                <div class="widget-content widget-content-area">
                    ...
                    <form wire:submit.prevent="save" class="row g-3" novalidate>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-6">
                                <input type="text" wire:model="loan.date_payment" wire:change="updateNoMonth" class="form-control @error('loan.date_payment') is-invalid @enderror" id="loan-date_payment">
